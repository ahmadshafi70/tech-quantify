@extends('layouts.app')
@section('meta_title')
Power Your Business with Reliable Hosting in Pakistan!
@endsection
@section('met_description')
Grow your business online with Tech Host.pk's secure & affordable business hosting. Superfast SSD storage, free SSL certificates, 24/7 support. Start Your Success Today!
@endsection
@section('code')
            ...
            <div class="col-lg-12 text-center">
                <div class="xs-banner-content">
                    <div class="xs-banner-group">
                        <h2 class="banner-title wow fadeInLeft" data-wow-duration="1s">Introducing our Business Hosting: Where Reliability Meets Performance</h2>
                    </div>
        ...
        <div class="row">
            <div colass="col-md-6 mx-auto">
                <div class="xs-heading wow fadeIn">
                    <h3 class="heading-title">Launch your business into the stratosphere<span> with our powerful hosting</span></h3>
                </div><!-- .xs-heading END -->
            </div>
        </div><!-- .row END -->
    </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="xs-single-pricing">
                                    <div class="pricing-header">
                                        ...
                                        <h3 class="xs-title"><b>Business Pro</b></h3>
                                        <!-- price details -->
                                        <div class="pricing-body">
                                            <div class="pricing-price">
                                            <!-- <p>Starting at</p> -->
                                            <h2 class="p"><sup>Rs.</sup>7000</h2>
                                            <h6 class="discount-price">25% Discount<del>Rs.9000</del></h6>
                                            </div>
                                        </div><!-- .pricing-body END -->
                                        <a href="https://billing.techhost.pk/index.php?rp=/store/bu/business-pro" class="btn btn-primary">Buy Now</a>
                                        <!-- <h4 style="margin-top: 15px; color: #15095e;">Now 40% Off</h4> -->
                                        <ul class="pricing-card-list" style="text-align: left; padding: 7px;">
                                            <li class="pricing-card-list-items package-features"><i class="fa fa-check white-tick" aria-hidden="true"></i>Discounted Domain&nbsp;
                                            </li>
                                            <li class="pricing-card-list-items package-features"><i class="fa fa-check white-tick" aria-hidden="true"></i> Unlimited  Accounts&nbsp;</li>
                                            <li class="pricing-card-list-items package-features"><i class="fa fa-check white-tick" aria-hidden="true"></i>3  Sub Domains&nbsp;
                                            </li>
                                            <li class="pricing-card-list-items package-features"><i class="fa fa-check white-tick" aria-hidden="true" style="margin-right: 4px"></i>1 MySQL Database&nbsp;
                                            </li>
                                            <li class="pricing-card-list-items package-features"><i class="fa fa-check white-tick" aria-hidden="true" style="margin-right: 4px"></i>Unlimited Bandwidth&nbsp;</li>
                                            <li class="pricing-card-list-items package-features"><i class="fa fa-check white-tick" aria-hidden="true" style="margin-right: 4px"></i>10  Email Accounts&nbsp;</li>
                                            <li class="pricing-card-list-items package-features"><i class="fa fa-check white-tick" aria-hidden="true" style="margin-right: 4px"></i>Virust & Spam Protection&nbsp;</li>
                                            <li class="pricing-card-list-items package-features"><i class="fa fa-check white-tick" aria-hidden="true" style="margin-right: 4px"></i>Free SSL&nbsp;</li>
                                            <li class="pricing-card-list-items package-features"><i class="fa fa-check white-tick" aria-hidden="true" style="margin-right: 4px"></i>1 Click WordPress Installation&nbsp;</li>
                                            <li class="pricing-card-list-items package-features"><i class="fa fa-check white-tick" aria-hidden="true" style="margin-right: 4px"></i>Anti DDOS Firewall&nbsp;</li>
                                            <li class="pricing-card-list-items package-features"><i class="fa fa-check white-tick" aria-hidden="true" style="margin-right: 4px"></i>Free Migration&nbsp;</li>

                                            <li class="pricing-card-list-items package-features"><i class="fa fa-check white-tick" aria-hidden="true"></i>Entry Power&nbsp;
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="xs-single-pricing" >
                                    <div class="pricing-header">
                                        ...
                                        <h3 class="xs-title"><b>Business Elite</b></h3>
                                        <!-- price details -->
                                        <div class="pricing-body">
                                            <div class="pricing-price">
                                            <!-- <p>Starting at</p> -->
                                        ...
                                        <a href="https://billing.techhost.pk/index.php?rp=/store/bu/business-elite" class="btn btn-primary">Buy Now</a>
                                        <!-- <h4 style="margin-top: 15px; color: #15095e;">Now 40% Off</h4> -->
                                        <ul class="pricing-card-list" style="text-align: left; padding: 7px;">
                                            <li class="pricing-card-list-items package-features"><i class="fa fa-check tick" aria-hidden="true"></i>Free Domain .com .co.uk &nbsp;
                                            </li>
                                            <li class="pricing-card-list-items package-features"><i class="fa fa-check tick" aria-hidden="true" ></i>3 WordPress Website&nbsp;</li>
                                            ...
                                            <li class="pricing-card-list-items package-features"><i class="fa fa-check tick" aria-hidden="true" style="margin-right: 4px"></i>Unlimited Bandwidth&nbsp;
                                            </li>
                                            <li class="pricing-card-list-items package-features"><i class="fa fa-check tick" aria-hidden="true" style="margin-right: 4px"></i>30 Email Accounts&nbsp;</li>
                                            ...
                                            <li class="pricing-card-list-items package-features"><i class="fa fa-check tick" aria-hidden="true"></i>Entry Power&nbsp;
                                                <i class="fa fa-info-circle tick" aria-hidden="true">
                                                 <span class="litooltip " style="background:black;">iNodes-60000<br>CPU(%)-100<br>RAM(1 GB)-<br>EP-30<br>I/O(MB/sec)-1024<br>
                                                </span>
                                                </i>
                                            </li>
                                        </ul>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 mx-auto">
                <div class="xs-heading wow fadeIn">
                    <h2 class="heading-sub-title">Business Hosting</h2>
                    <h3 class="heading-title">WHY <span>BUSINESS HOSTING</span></h3>
                </div><!-- .xs-heading END -->
            </div>
        </div><!-- .row END -->
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="why-choose-us-block wow fadeInUp">
                    ...
                    <p>Downtime is not an option. We back your business with a 99.9% uptime guarantee, ensuring your website is accessible to customers around the clock, no matter where they are.</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="why-choose-us-block wow fadeInUp" data-wow-duration="1.5s">
                    ...
                    <p>Protecting your digital assets is our priority. Our robust security measures, including firewalls, SSL certificates, and malware scans, safeguard your business data and customer information.</p>
                </div><!-- .why-choose-us-block END -->
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="why-choose-us-block wow fadeInUp" data-wow-duration="2s">
                    ...
                    <p>Focus on what you do best while we handle the technicalities. Our dedicated support team is available around the clock to address any issues, answer your questions, and ensure your business stays online.</p>
                </div><!-- .why-choose-us-block END -->
            </div>
        </div>
    </div><!-- .container END -->
                ...
                <div class="include-feature-list">
                    <div class="media hosting-info-list">
                        ...
                        <div class="media-body">
                            <h4 class="xs-title">Blazing-Fast Loading Speeds</h4>
                            <p>Every second counts in the online world. Our Business Hosting utilizes high-performance servers and optimized configurations to ensure lightning-fast loading speeds, keeping your visitors engaged and satisfied.</p>
                        </div>
                    ...
                    <div class="media hosting-info-list">
                        ...
                        <div class="media-body">
                            <h4 class="xs-title">Reliable Uptime</h4>
                            <p>Downtime can be detrimental to your business. We guarantee exceptional uptime, so your website remains accessible to customers around the clock, boosting your credibility and customer trust.</p>
                        </div>
                    </div><!-- .hosting-info-list END -->
                    <div class="media hosting-info-list">
                        <div class="d-flex info-icon">
                        ...
                        <div class="media-body">
                            <h4 class="xs-title">Robust Security Layers</h4>
                            <p>Protecting your business and customer data is paramount. Our Business Hosting comes with advanced security features, including firewalls, malware scans, SSL certificates, and regular backups.</p>
                        </div>
                    </div><!-- .hosting-info-list END -->
            ...
            <div class="col-lg-6">
                <div class="include-feature-list">
                    <div class="media hosting-info-list">
                        ...
                        <div class="media-body">
                            <h4 class="xs-title">Easy-to-Use Control Panel</h4>
                            <p> Managing your hosting environment is made simple with an intuitive control panel. Control all aspects of your website, from email accounts to domain settings, with ease.</p>
                        </div>
                    </div><!-- .hosting-info-list END -->
                    <div class="media hosting-info-list">
                        <div class="d-flex info-icon">
                        ...
                        <div class="media-body">
                            <h4 class="xs-title">Optimized for E-Commerce</h4>
                            <p>If you're running an online store, our Business Hosting is tailored to enhance your e-commerce experience. Fast loading times and secure transactions contribute to higher conversions and customer satisfaction.</p>
                        </div>
                    </div><!-- .hosting-info-list END -->
                    <div class="media hosting-info-list">
                        <div class="d-flex info-icon">
                        ...
                        <div class="media-body">
                            <h4 class="xs-title">Email Solutions</h4>
                            <p>Communicate professionally with custom email addresses that match your domain. Our Business Hosting includes reliable email services to keep your correspondence efficient and secure.</p>
                        </div>
                    </div><!-- .hosting-info-list END -->
                </div><!-- .include-feature-list END -->
            </div>    
...
<section class="xs-section-padding">
    <div class="container">
        ...
        <div class="row" style="margin-top:-30px">
                <p>In today's competitive digital landscape, having a strong online presence is crucial for any business. Our Business Hosting services are tailored to provide you with the robust resources and cutting-edge technology needed to fuel your business growth. Whether you're a small startup, a growing enterprise, or an established brand, our hosting solutions are designed to meet your specific needs and exceed your expectations.
                </p>
                <p>Your business journey is unique, and so are your hosting needs. Our Business Hosting is designed with your success in mind. We understand the challenges businesses face in the digital landscape and are committed to providing the tools, support, and infrastructure to help you flourish. With a focus on performance, security, and customer satisfaction, we're here to empower your business to reach its full potential.</p>
                <p>At Tech Host, we believe that exceptional customer support is essential for business success. That's why our team of hosting experts is available 24/7 to assist you with any questions or issues you may encounter. Whether you need help setting up your hosting account, troubleshooting technical issues, or optimizing your website for performance, we're here to help you every step of the way.</p>
                <p>When you choose our Business Hosting, you're choosing a partner dedicated to your success. We understand the unique challenges businesses face in the digital realm and are committed to providing you with the tools and support you need to thrive. With a focus on performance, security, and customer satisfaction, we're here to elevate your online presence and empower your business for growth.</p>
                <p>Elevate your business to new heights with our Business Hosting solutions. Join us today and experience hosting that's as reliable and dynamic as your business itself!
                </p>
                <p>In conclusion, Tech Host is your trusted partner for business hosting in Pakistan. With our top-tier performance, robust security, customizable packages, and expert support, we provide everything you need to power your online presence and propel your business forward. Get started with Tech Host today and take your business to new heights online!</p>
        </div>
    </div><!-- .container END -->
</section><!-- END shared hosting details section -->
